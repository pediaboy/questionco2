            ...
            <Panel size={12}>
              ...
              <div className="p-4">
                <span className="mb-3 block font-mono text-[9px] uppercase tracking-[0.25em] text-slate-500">
                  Breakdown Level TP ({result.strategy === "xau_scalp_ema_bb_rsi_psar_v1" ? "dinamis dari Bollinger (quick scalp)" : result.pair === "BTCUSDT" ? "150/200/500 pips (swing)" : "RR dinamis dari ATR"})
                </span>
