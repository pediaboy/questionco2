...
export default function PapanPeringkatPage() {
  ...
  // Order for podium display: rank2 (left), rank1 (center, tallest), rank3 (right)
      ...
      <main className="max-w-lg mx-auto px-5 pt-8 pb-16">
        ...
        {loading ? (
          ...
          <>
              ...
              {podiumOrder.map((idx) => {
                ...
                return (
                  <motion.div
                    key={idx}
                    layout
                    className={`flex flex-col items-center ${style.order} w-24`}
                  >
            ...
            >
              GABUNG KONTES SEKARANG <ArrowRight size={14} />
            </Link>
          </>
        )}
      </main>
